...
export async function AddPlayerToDatabase(db: LocalDatabase, playerId: string, playerName: string) {
  ...
  const _p = { name: playerName, won:0, lost:0, points: config.initialPlayersPoints ?? 0, maps: {}, teamMates: {}, wins: {}, losses: {}, mode:{}, encounters:{}, unclaimedPoints: config.initialPlayersPoints ?? 0, id: parseInt(playerId) };
